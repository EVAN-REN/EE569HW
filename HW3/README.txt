...
3.Change the outputPath in the main method of p1/p2/p3 to the absolute address of the HW3 project
...
HomographicTrans.h/HomographicTrans.cpp :
...
MorphologyProc.h/MorphologyProc.cpp :
